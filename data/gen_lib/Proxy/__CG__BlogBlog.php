 ...
 */
class Blog extends \Blog\Blog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'categories', 'id', 'h1', 'status', 'deleted', 'published', 'image', 'short_text', 'user', 'parts', 'route', 'subpath', 'parent', 'sort1', 'past2', 'rating', 'created', 'updated', 'attr', 'analytics', 'meta'];
        }
