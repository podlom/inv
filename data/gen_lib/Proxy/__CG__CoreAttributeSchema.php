 ...
 */
class Schema extends \Core\Attribute\Schema implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'type', 'page', 'required'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Schema $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setType(\Core\Attribute\Type $type)
    {
