 ...
 */
class Mailing extends \Mail\Mailing implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'recipients', 'created', 'updated'];
        }
     ...
     * {@inheritDoc}
     */
    public function addRecipient(\Mail\Recipient $recipient)
    {
     ...
     * {@inheritDoc}
     */
    public function removeRecipient(\Mail\Recipient $recipient)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeRecipient', [$recipient]);
