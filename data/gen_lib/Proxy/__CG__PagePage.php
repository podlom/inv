...
namespace Proxy\__CG__\Page;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Page extends \Page\Page implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'h1', 'status', 'deleted', 'published', 'image', 'short_text', 'user', 'parts', 'route', 'subpath', 'parent', 'sort1', 'past2', 'rating', 'created', 'updated', 'attr', 'analytics', 'meta'];
        }
    ...
    public function getPath($default = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPath', [$default]);

        return parent::getPath($default);
    }
