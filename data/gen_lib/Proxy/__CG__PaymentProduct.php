 ...
 */
class Product extends \Payment\Product implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'invoice', 'index', 'name', 'count', 'price', 'data'];
        }
     ...
     * {@inheritDoc}
     */
    public function setInvoice(\Payment\Invoice $invoice)
    {
    ...
    public function set($name, $val)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'set', [$name, $val]);
