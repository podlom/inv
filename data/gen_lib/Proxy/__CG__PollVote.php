 ...
 */
class Vote extends \Poll\Vote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'variant', 'user'];
        }
     ...
     * {@inheritDoc}
     */
    public function setVariant(\Poll\Variant $variant = NULL)
    {
