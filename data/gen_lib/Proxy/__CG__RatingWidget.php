 ...
 */
class Widget extends \Rating\Widget implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'ratings', 'id', 'name', 'description', 'status', 'options', 'init'];
        }
     ...
     * {@inheritDoc}
     */
    public function addRating(\Rating\Rating $ratings)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addRating', [$ratings]);
     ...
     * {@inheritDoc}
     */
    public function removeRating(\Rating\Rating $ratings)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeRating', [$ratings]);
