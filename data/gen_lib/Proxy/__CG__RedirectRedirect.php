...
namespace Proxy\__CG__\Redirect;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Redirect extends \Redirect\Redirect implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'route', 'status', 'target', 'created', 'updated'];
        }
     ...
     * {@inheritDoc}
     */
    public function setRoute(\Core\Route $route)
    {
