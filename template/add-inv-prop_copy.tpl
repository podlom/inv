...
<div class="section__heading">
    <p class="section__text">
        Основываясь на многолетнем и успешном опыте работы на инвестиционном рынке, InVenture разработала для соискателей
        инвестиций и продавцов бизнеса комплекс технологических инструментов, направленных на скорейшую продажу компаний
...
<div class="services__wrapper">
    <div class="services__blocks">
        <div class="services__block services__block--green">
            <div class="services__block-wrapper">
                ...
                <button class="services__button open_popup" data-dealName="Реклама и продвижение" data-src="#dealName"
        ...
        <div class="services__block services__block--blue">
            ...
            <ul class="services__list">
                <li>Индивидуальный комплекс продвижения и рекламы инвестиционного предложения</li>
                <li>Разработка профессиональной презентации для работы с инвесторами</li>
                <li>Консультационное сопровождение на всех этапах сделки</li>
                <li>Прямые продажи</li>
            </ul>
            <button class="services__button open_popup" data-dealName="Индивидуальный подход" data-src="#dealName"
                data-action="updateInfo">Получить условия</button>
    ...
    <div class="services__achives">
        ...
        <div class="services__achive">
            ...
            <div class="services__achive-title">база инвесторов (Украина, СНГ, ЕС, США, Азия)</div>
        </div>
        <div class="services__achive">
            <div class="services__achive-num">500+</div>
            <div class="services__achive-title">клиентов нашли выход на инвесторов</div>
        </div>
        <div class="services__achive">
        ...
        <div class="services__achive">
            <div class="services__achive-num">$170+</div>
