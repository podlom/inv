		...
		<div class="container">
			<div class="investor-proposals__header">
				<div>
					...
					<div class="investor-proposals__description">
						<p>
							За більш ніж 10 років роботи на інвестиційному ринку України, ми
							розробили дієві інструменти із залучення
			...
			<div class="investor-proposals__form">
				<div class="investor-proposals__proposal proposal">
					...
					<p class="proposal__description">Підійде для продажу малого або
						середнього бізнесу, об'єкта нерухомості,
					франшизи або стартапу, коли потрібно донести інформацію до широкого
					кола інвесторів.</p>
				...
				<ul class="proposal__features-list">
					...
					<li>Розміщення на спеціалізованих інтернет майданчиках та дошках
						оголошень</li>
			...
			<div class="investor-proposals__proposal proposal proposal--blue">
				...
				<p class="proposal__description">
					Підійде для продажу середнього та великого бізнесу, залучення
					інвестицій у масштабні інвестпроекти, коли
