...
{/script_code}
    ...
    <div class="clearfix border-bottom">
        <h2> {if $request->getPathInfo() == '/en/analytics'}
           Analytics
          {elseif $request->getPathInfo() == '/en/analytics/investments'}
          Research
          {elseif $request->getPathInfo() == '/en/analytics/articles'}
          Articles
          {elseif $request->getPathInfo() == '/en/analytics/formula'}
          Interview
          {elseif $request->getPathInfo() == '/en/analytics/we-invest-in-ukraine'}
