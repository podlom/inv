    ...
    <div class="post__wrapper">
        <div class="post__preview">
            <div class="preview__wrapper-main pt-6 mobile-mt-0">
                <h1 class="preview__title mb-2">Бібліотека інвестора – джерело знань для інвесторів</h1>
                ...
                <div class="hidden">
                    ...
                    <form name="library-form" method="get">
                        <div class="library-form__input">
                            ...
                            <button class="blue_but m_t-5" type="submit" aria-label="submit form">Пошук</button>
                        </div>
                        <div class="grid-x">
