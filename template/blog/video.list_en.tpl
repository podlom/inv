...
{/script_code}
    <section class="grid-container news_list video_list">
              ...
              <div style="position: relative; background-color: white;">
                ...
                <div class="auto-height">
                    <div class="medium-{$post_size.0|default:5} columns photo-in {$image_class}">
                        <iframe class="video-iframe" itemscope itemtype="http://schema.org/ImageObject" src="//www.youtube.com/embed/{$post->printAttr("55")}" frameborder="0" allowfullscreen></iframe>
                    </div>
