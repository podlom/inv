      ...
      <img src="/images/logo.svg" alt="Inventure logo" />
		...
		<div class="flex ml-auto">
			<div class="header__socials flex">
				<a class="header__social-icon" itemprop="sameAs" href="https://www.facebook.com/inventure.com.ua" target="_blank">
					<svg xmlns="http://www.w3.org/2000/svg" fill="#fff" enable-background="new 0 0 512 512" height="35" viewBox="0 0 512 512" width="34"><path d="m512 256c0-141.4-114.6-256-256-256s-256 114.6-256 256 114.6 256 256 256c1.5 0 3 0 4.5-.1v-199.2h-55v-64.1h55v-47.2c0-54.7 33.4-84.5 82.2-84.5 23.4 0 43.5 1.7 49.3 2.5v57.2h-33.6c-26.5 0-31.7 12.6-31.7 31.1v40.8h63.5l-8.3 64.1h-55.2v189.5c107-30.7 185.3-129.2 185.3-246.1z"/></svg>
				</a>
				<a class="header__social-icon" itemprop="sameAs" href="https://t.me/inventure" target="_blank">
					<svg xmlns="http://www.w3.org/2000/svg" fill="#fff" enable-background="new 0 0 24 24" height="35" viewBox="0 0 24 24" width="34"><path d="m12 24c6.629 0 12-5.371 12-12s-5.371-12-12-12-12 5.371-12 12 5.371 12 12 12zm-6.509-12.26 11.57-4.461c.537-.194 1.006.131.832.943l.001-.001-1.97 9.281c-.146.658-.537.818-1.084.508l-3-2.211-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.121l-6.871 4.326-2.962-.924c-.643-.204-.657-.643.136-.953z"/></svg>
				</a>
      ...
      {foreach $locale_data as $langArr=>$data}
          ...
          <div class="header__right-item header__right-item--lang">
            ...
            >
              ...
              >
                <path
									style="fill: var(--main-accent-color);"
