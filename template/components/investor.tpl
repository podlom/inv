		...
		<div class="container">
			<div class="investor__header-text">
				...
				<div class="investor__description">
					...
					{else}
						Заповніть будь ласка форму, це допоможе нам визначити ваші уподобання та інвестиційні критерії для підбору
						найбільш підходящих пропозицій. Ми гарантуємо дотримання повної конфіденційності.
					{/if}
				</div>
			</div>
		</div>
              ...
              /> *}
				...
				<div class="form__section">
					...
					<div class="form__fields form__fields--light form__fields--small">
						...
						{else}
						Обираючи цю функцію, Ви замовляєте дзвінок від менеджера InVenture, який зможе надати додаткову консультацію
						з питань, що Вас цікавлять, і прискорити процес підбору інвестиційної пропозиції
						{/if}
					...
					<div class="footer__agreement">
						...
						<label class="cbx cbx--white" for="privacy" type="checkbox">
							...
							<span>
								...
								{else}
								Я погоджуюсь на обробку персональних даних згідно з політикою конфіденційності.
								{/if}
...
<script>
	...
	const formFields = [{
			name: 'sf_investor[types][]',
			title: 'Приоритетні напрямки інвестування',
			type: 'checkbox',
			fields: [
				...
				'Машинобудування та виробництво електрообладнання',
				...
				'Телекомунікації та звʼязок',
				'Мистецтво, розваги, спорт та відпочинок',
				'Електроенергетика та паливна промисловість',
				'Водозабезпечення та переробка відходів',
				'Інформаційні технології та інтернет проекти',
				'Інновації та високі технології',
				'Охорона здоровʼя та соціальна допомога',
				'Споживчі послуги',
				'Освіта',
				'Організації та асоціаціїї'
			],
		},
		{
			name: 'sf_investor[stage][]',
			title: 'Cтадії інвестування',
			type: 'checkbox',
			fields: [
				'Стартап',
				'Рання стадія',
				'Стадія зростання та розширення',
				'Проблемний актив',
			],
		},
		{
			name: 'sf_investor[profit][]',
			title: 'Очікувана дохідність інвестицій',
			type: 'checkbox',
			fields: ['10% – 15%', '15% – 20%', '20% – 25%', '25% – 30%', 'понад 30%'],
		},
		{
			name: 'sf_investor[location][]',
			title: 'Регіон',
		...
		{
			name: 'sf_investor[inv][]',
			title: 'Форма інвестування',
			type: 'checkbox',
			fields: [
				'Кредитування',
				'Співробітництво',
				'Контрольний пакет (більше 50% частки у бізнесі)',
				'Міноритарний пакет (менше 50% частки у бізнесі)',
			],
		},
		{
			name: 'sf_investor[involvement][]',
