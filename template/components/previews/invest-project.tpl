        ...
        <div class="preview__wrapper preview__wrapper--none-bg-desktop pb-6">
            <div class="preview__wrapper-block flex flex-col">
                      ...
                      <div class="swiper-wrapper  mb-4">
                          ...
                          {if $post->hasImage()}
                              ...
                              <a href="{($post->getImage()->getUrl())}" class="js-smartphoto swiper-slide">
                                  ...
                                  <img class="ts-main-post-image swiper-lazy" data-src="/img/thumbup.600.400{($post->getImage()->getUrl())}" alt="{$post->getH1()}">
                          ...
                          {foreach $post->getImages() as $image }
                              ...
                              {/if}
                                <a href="{($image->getUrl())}" class="js-smartphoto swiper-slide">
                                  ...
                                  {/if}
                                  <div class="img-overlay mobile-only opacity-75"></div>
                                  <img class="swiper-lazy main-img-id-{$mainImageId} img-id-{($image->getId())}" data-src="/img/thumbup.600.400{($image->getUrl())}" alt="{$post->getH1()}">
                                  <div class="swiper-lazy-preloader"></div>
                                </a>
                          {/foreach}
                        </div>
                          ...
                          <div class="swiper-wrapper">
                              {if $post->hasImage()}
                                  <div class="swiper-slide">
                                      <img class="swiper-lazy" data-src="/img/thumbup.350.254{$post->getImage()->getUrl()}" alt="{$post->getH1()}">
                                      <div class="swiper-lazy-preloader"></div>
                                  </div>
                              {/if}
                            {foreach $post->getImages() as $image }
                ...
                <div class="desktop-only mt-auto pt-4 flex">
                      ...
                      <p class="flex items-center opacity-75 text-sm  mr-4 font-semibold text--grey">ID: {$post->getId()}</p>
