<section class="reviews">
  ...
  <h2 class="reviews__title">
    {if $title}
      {$title}
    {else}
      {if $lang === 'ru'}Вот что клиенты говорят о нас{else}What Our Clients Say About Us{/if}
    {/if}
  </h2>
              ...
              <div class="reviews__footer">
                ...
                <div class="reviews__socials">
                  {if $review->getFacebookUrl()}
                      <a target="_blank" class="reviews__socials-link"  draggable="true" data-href="{$review->getFacebookUrl()}" href="{$review->getFacebookUrl()}">
                        <img src="/images/icons/fb-icon.svg" class="reviews__socials-icon" alt="" />
                      </a>
                  {/if}
                  {if $review->getLinkedinUrl()}
                    <a href="#" class="reviews__socials-link"draggable="true" data-href="{$review->getLinkedinUrl()}" href="{$review->getLinkedinUrl()}">
                      <img src="/images/icons/in-icon.svg" class="reviews__socials-icon" alt="alt="{$review->getFullName()}" " />
                    </a>
                  {/if}
                </div>
              </div>
