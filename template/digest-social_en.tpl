	...
	<section class="subscription">
			...
			<div class="container grid-container">
				<div class="subscription__wrapper">
					...
					<p class="subscription__text--white subscription__text">
						A monthly investment magazine for private equity and venture capital.
					</p>
				</div>
			</div>
		</div>
		<div class="subscription__bottom container grid-container">
			<div class="subscription__info">
				...
				<p class="subscription__text">Компактность и удобство для читателя - «Все самое важное в сфере инвестиций - за 1
					месяц - на 10 страницах - за 5 минут» (для деловых людей, когда ограниченно время на чтение деловой прессы).</p>
				<p class="subscription__text">Разноплановый контент: от новостной и аналитической информации до актуальных
					инвестиционных предложений.</p>
				<p class="subscription__text">Уникальная целевая аудитория подписчиков, база которых формируется на протяжении
					более 20 лет деятельности в области инвестиционного бизнеса (по состоянию на 01.01.2019 - 13 700+ подписчиков).
				</p>
				<p class="subscription__text">Активное пополнение базы подписчиков - бесплатная онлайн подписка.</p>
				<p class="subscription__text">Инвестиционный дайджест нашел одобрение со стороны большого количества подписчиков и
					способствовал заключению множества инвестиционных сделок.</p>
			</div>
			<form action="/!Mail" class="subscription__form">
				...
				<button type="submit" class="subscription__button g-recaptcha digest-social-en"
