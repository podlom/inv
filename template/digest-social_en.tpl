    ...
    <section class="subscription">
        ...
        <div class="subscription__bottom container grid-container">
            ...
            <form action="/!Mail" class="subscription__form">
                ...
                <button type="submit" class="subscription__button g-recaptcha digest-social-en" data-sitekey="6Le8bI8fAAAAAFT1lTrt6gL31hrhm8mFfc4nKmbX" data-callback="submitDigest">
                        Подписаться
                </button>
            </form>
