        ...
        <div class="subscription__bottom grid-container container">
            ...
            {$first = reset($digests)}
                    <div class="w-full" style="position: relative;">
                      ...
                      <p style="max-width: 640px;text-align: center;margin: 0 auto 20px;">Інвестиційний дайджест InVenture - найважливіше в галузі інвестицій за місяць, на 10 сторінках, всього за 5 хвилин!</p>
