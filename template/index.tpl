    ...
    <main class="main large-9">
      <section>
        ...
        <div class="section__title-categories pt-0 mb-2 pb-0 flex flex-row justify-between items-center mt-4">
          <a href="/news"><h2  class="section__title-categories pr-4">Новости</h2></a>
          <ul class="sort desktop-only text-xs">
            <li class="sort__item"><a href="/news">Все</a></li>
            <li class="sort__item"><a href="/news/ukraine">Украина</a></li>
            <li class="sort__item"><a href="/news/world">Мир</a></li>
          </ul>
        </div>
      ...
      <section>
        <h2 class="section__title-categories mt-4"><a href="/analytics">Аналитика</a></h2>
        <div class="relative z-0">
          <div class="section__categories-overlay"></div>
          <nav class="section__categories">
      ...
      <section id="events">
        <h2 class="section__title-categories mt-4"><a href="/tools/events">Мероприятия</a></h2>
        {$event=[]}
      ...
      <section class="news">
        <h2 class="section__title-categories mt-4"><a href="/tools/video">Видео</a></h2>
