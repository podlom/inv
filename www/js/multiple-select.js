			...
			return (
				r(i, [
					...
					},
					{
						...
						value: function() {
							...
							if (
								...
								(this.selectAllName = 'data-name="selectAll'.concat(
									i,
									'"',
								)),
								...
								(this.selectItemName = 'data-name="selectItem'.concat(
									i,
									'"',
								)),
					...
					},
					{
						...
						value: function() {
							var e = this;
							(this.$searchInput = this.$drop.find(
								'.ms-search input',
							)),
