  ...
  return (
    <section>
      ...
      <div className="relative ">
        ...
        >
          <CarouselContent className="mx-4 sm:mx-[calc((100vw-640px)/2+24px)] md:mx-[calc((100vw-768px)/2+24px)] lg:mx-[calc((100vw-1024px)/2+32px)] xl:mx-[calc((100vw-1280px)/2+32px)] 2xl:mx-[calc((100vw-80rem)/2+32px)]">
