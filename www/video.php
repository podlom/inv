    ...
    if (isset($_REQUEST['action']) && ($_REQUEST['action'] == 'video-list'))
    {
        ...
        if (
            ...
            switch ($_REQUEST['lang']) {
                case 'uk':
                    $attrVideoCategoryId = 75;
                    break;
                case 'ru':
                    $attrVideoCategoryId = 77;
                    break;
                case 'en':
                    $attrVideoCategoryId = 76;
                    break;
            }
        ...
        l_m(__FILE__ . ' +' . __LINE__ . ' Result123: ' . var_export($res322, true));
